...
def get_ebay_product_details(url):
    ...
    '''title_elem = soup.find('div', {'class': 'ux-layout-section-evo'})
    if title_elem:
    ...
    '''desc_elem = soup.find('div', {'class': "ux-layout-section-evo_item ux-layout-section-evo_item--table-view"})
    if desc_elem:
        description = desc_elem.text.strip()
    else:
        description = "Description not found"'''

    # Print or return product details
    '''print("Title:", title)'''
    print("Price:", price)
